...
Description: Custom shortcodes for this page
Author: Martins M
Version: 1.1.1
*/
...
require_once( dirname(__FILE__) . "/class/Custom_Markup_Shortcodes.php" );

require_once( dirname(__FILE__) . "/class/Custom_Shortcodes.php" );
