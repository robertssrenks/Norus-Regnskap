 ...
 */
	...
	class UniteSettingsBiz{
		...
		const TYPE_IMAGE_LIBRARY = "image_library";
		...
		//-----------------------------------------------------------------------------------------------
		//add image selector
		public function addImageLibrary($name,$defaultValue = "",$text = "",$arrParams = array()){
			$this->add($name,$defaultValue,$text,self::TYPE_IMAGE_LIBRARY,$arrParams);
		}
