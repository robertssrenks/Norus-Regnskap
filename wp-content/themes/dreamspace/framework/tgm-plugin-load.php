...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		// gw shortcodes plugin
		array(
			'name'     				=> 'GW Shortcodes Plugin', // The plugin name
			'slug'     				=> 'gw-shortcodes', // The plugin slug (typically the folder name)
			'source'   				=> get_stylesheet_directory() . '/framework/plugins/gw-shortcodes.zip', // The plugin source
