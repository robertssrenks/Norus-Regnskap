    <div class="footer-wrapper">  
		<div class="container">
            ...
            <div class="row">
                ...
                <!-- widget 4 -->  
                <div class="col-md-3 fbox">
					<?php if (function_exists('dynamic_sidebar') && dynamic_sidebar('fsidebar-4') ) : else : ?>

                        <h4><?php _e('footer sidebar 4', 'framework'); ?></h4>
                        <div class="textwidget">
                            <p><?php _e('Currently there are no widgets in Footer Sidebar 4 area. To insert your content here, please drag and drop widgets to this area.', 'framework'); ?></p> 
                        </div>          
