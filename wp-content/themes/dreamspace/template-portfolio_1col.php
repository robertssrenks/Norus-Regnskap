<?php 
/*
Template Name: Portfolio 1 columns template
*/
...
$pag_portfolio = $goldenworks['pag_port1c'];
...
<section>
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            ...
            <div class="portfolio-filter-wrapper pfw-1col">
            ...
            <div class="content pxd1-parent">
                ...
                <ul id="portfolio-container" class="portfolio-wrapper">
                    ...
                    <!-- portfolio 1 column -->
                    <li class="pxd-1 portfolio-item <?php echo $sclass; ?>">
    
                        <!-- portfolio entry -->
                        <article class="port-article row">
                                ...
                                <div class="col-md-7 port1col-content">
