...
$pag_portfolio = $goldenworks['pag_port2c'];
...
<section>
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            ...
            <!-- portfolio filter -->
            <?php if ($goldenworks['p2col-filter'] == 1) { ?> 
            <div class="portfolio-filter-wrapper pfw-2col">
            ...
            <div class="content pxd2-parent">
                ...
                <ul id="portfolio-container" class="portfolio-wrapper">
                    ...
                    <!-- portfolio 1/2 column -->
                    <li class="pxd-2 portfolio-item <?php echo $sclass; ?>">
