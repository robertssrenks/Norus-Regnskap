<?php 
/*
Template Name: Portfolio 3 columns grid
*/
...
$pag_portfolio = $goldenworks['pag_port3g'];
...
<section>
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            ...
            <!-- portfolio filter -->
            <?php if ($goldenworks['p3colg-filter'] == 1) { ?> 
            <div class="portfolio-filter-wrapper pfw-3grid">
