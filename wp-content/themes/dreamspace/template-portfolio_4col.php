<?php 
/*
Template Name: Portfolio 4 columns template
*/
...
$pag_portfolio = $goldenworks['pag_port4c'];
...
<section>
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            ...
            <!-- portfolio filter -->
            <?php if ($goldenworks['p4col-filter'] == 1) { ?> 
            <div class="portfolio-filter-wrapper pfw-4col">
